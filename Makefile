...
init:
	...
	docker compose run chirpstack-gateway-os openwrt/scripts/feeds update -a
	docker compose run chirpstack-gateway-os openwrt/scripts/feeds install -a
	docker compose run chirpstack-gateway-os quilt init
...
devshell:
	docker compose run chirpstack-gateway-os bash
